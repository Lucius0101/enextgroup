(function() {
	...
	Zbox.prototype.createHTML = function() {
		...
		this.header.appendChild(this.header_span);
	};
	...
	Zbox.prototype.addListeners = function() {
		...
		this.header_span.addEventListener("click", hide(this), false);
		
		this.header_span.addEventListener("mouseover", function(e) {
		
			e.target.style.color 		= "#fbfbfb";
			e.target.style.textShadow 	= "0px 1px 1px #000";

		}, false);
		
		this.header_span.addEventListener("mouseout", function(e) {
